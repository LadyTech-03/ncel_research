                  ...
                  <div className="flex flex-col md:flex-row gap-6">
                    <div className="md:w-1/3 h-[300px] md:h-auto">
                      <img 
                        ...
                        className="w-full h-full object-cover rounded-lg md:rounded-xl md:rounded-tr-none"
                      />
                    </div>
                    <div className="flex-1 p-4 md:p-6">
                      <CardHeader className="p-0 md:p-0">
                        ...
                        <CardDescription className="text-base lg:text-xl text-foreground leading-relaxed">
                          {project.description}
                        </CardDescription>
                      </CardHeader>
                      
                      <CardContent className="p-0 md:p-0 mt-6">
                        <Tabs defaultValue="activities" className="w-full">
                          <TabsList className="grid w-full grid-cols-3">
                            <TabsTrigger value="activities" className="flex items-center gap-1 text-xs md:text-sm">
                              <Activity className="h-4 w-4 hidden md:block" />
                              Activities
                            </TabsTrigger>
                            <TabsTrigger value="events" className="flex items-center gap-1 text-xs md:text-sm">
                              <Calendar className="h-4 w-4 hidden md:block" />
                              Events
                            </TabsTrigger>
                            <TabsTrigger value="publications" className="flex items-center gap-1 text-xs md:text-sm">
